...
export default function DatenschutzPage() {
    return (
        <main className="max-w-4xl mx-auto p-8 space-y-8 text-gray-700">
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="mb-8 p-4 border border-gray-300 rounded-md bg-gray-50">
                    <p className="text-gray-700">
                        Diese Datenschutzerklärung ist das deutsche Original.
                        Die Übersetzungen dienen nur zur Information. Im Falle
                        von Abweichungen oder Unstimmigkeiten hat die deutsche
                        Version Vorrang.
                    </p>
                </div>
                ...
                <div className="space-y-6 text-gray-700">
                    <div>
                        ...
                        <p className="mb-4">
                            ...
                            12.03.2025-112963921) verfasst, um Ihnen gemäß der
                            Vorgaben der{' '}
                            <a
                            ...
                            <br />
                            <strong>Kurz gesagt:</strong> Wir informieren Sie
                        ...
                        <p className="mb-4">
                            ...
                            <strong>Begriffe leserfreundlich erklärt</strong>,
                            Links zu weiterführenden Informationen geboten und{' '}
                            <strong>Grafiken</strong> zum Einsatz gebracht. Wir
                            informieren damit in klarer und einfacher Sprache,
                            dass wir im Rahmen unserer Geschäftstätigkeiten nur
                            dann personenbezogene Daten verarbeiten, wenn eine
                            ...
                            bitten, sich an die unten genannte verantwortliche
                            Stelle zu wenden, den vorhandenen Links zu folgen
                            und sich weitere Informationen auf Drittseiten
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside mb-4 space-y-1">
                            <li>
                                alle Onlineauftritte (Websites, Onlineshops),
                                die wir betreiben
                            </li>
                            <li>
                        ...
                        <p className="mb-4">
                            ...
                            Datenschutzerklärung gilt für alle Bereiche, in
                    ...
                    <div>
                        ...
                        <p className="mb-4">
                            ...
                            verarbeiten.
                            <br />
                            Was das EU-Recht angeht, beziehen wir uns auf die
                        ...
                        <ol className="list-decimal list-inside mb-4 space-y-2">
                            <li>
                                <strong>Einwilligung</strong> (Artikel 6 Absatz
                                1 lit. a DSGVO): Sie haben uns Ihre Einwilligung
                                gegeben, Daten zu einem bestimmten Zweck zu
                                verarbeiten. Ein Beispiel wäre die Speicherung
                                Ihrer eingegebenen Daten eines Kontaktformulars.
                            </li>
                            <li>
                                <strong>Vertrag</strong> (Artikel 6 Absatz 1
                                lit. b DSGVO): Um einen Vertrag oder
                                vorvertragliche Verpflichtungen mit Ihnen zu
                                erfüllen, verarbeiten wir Ihre Daten. Wenn wir
                                zum Beispiel einen Kaufvertrag mit Ihnen
                            ...
                            <li>
                                ...
                                einer rechtlichen Verpflichtung unterliegen,
                                verarbeiten wir Ihre Daten. Zum Beispiel sind
                                wir gesetzlich verpflichtet Rechnungen für die
                                Buchhaltung aufzuheben. Diese enthalten in der
                                Regel personenbezogene Daten.
                            </li>
                            <li>
                                <strong>Berechtigte Interessen</strong> (Artikel
                                6 Absatz 1 lit. f DSGVO): Im Falle berechtigter
                                Interessen, die Ihre Grundrechte nicht
                                einschränken, behalten wir uns die Verarbeitung
                                personenbezogener Daten vor. Wir müssen zum
                                Beispiel gewisse Daten verarbeiten, um unsere
                                Website sicher und wirtschaftlich effizient
                                betreiben zu können. Diese Verarbeitung ist
                        ...
                        <ul className="list-disc list-inside mb-4 space-y-1">
                            <li>
                                In <strong>Österreich</strong> ist dies das
                                Bundesgesetz zum Schutz natürlicher Personen bei
                                der Verarbeitung personenbezogener Daten (
                                <strong>Datenschutzgesetz</strong>
                    ...
                    <div>
                        ...
                        <p className="mb-4">
                            ...
                            Verarbeitung personenbezogener Daten haben, finden
                            Sie nachfolgend die Kontaktdaten der
                    ...
                    <div>
                        ...
                        <p className="mb-4">
                            ...
                            nach Wegfall des ursprünglichen Zwecks zu speichern,
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside mb-4 space-y-2">
                            <li>
                                Sie haben laut Artikel 15 DSGVO ein Recht auf
                                Auskunft darüber, ob wir Daten von Ihnen
                                verarbeiten. Sollte das zutreffen, haben Sie
                                Recht darauf eine Kopie der Daten zu erhalten
                                ...
                                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                                    ...
                                    <li>
                                        die Kategorien, also die Arten von
                                        Daten, die verarbeitet werden;
                                    </li>
                                    <li>
                                        wer diese Daten erhält und wenn die
                                        Daten an Drittländer übermittelt werden,
                                        wie die Sicherheit garantiert werden
                                        kann;
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        beschweren können (Links zu diesen
                                    ...
                                    <li>
                                        ...
                                        Daten automatisch ausgewertet werden, um
                                        zu einem persönlichen Profil von Ihnen
                                        zu gelangen.
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                eine Änderung der Verarbeitung zur Folge hat.
                                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                                    <li>
                        ...
                        <p className="mb-4">
                            <strong>Kurz gesagt:</strong> Sie haben Rechte –
                    ...
                    <div>
                        ...
                        <p className="mb-4">
                            ...
                            E-Mail-Adresse, eingegebene Formulardaten. Mehr
                            Details dazu finden Sie bei der jeweils eingesetzten
                            Kontaktart
                            <br />
                            ...
                            (Vertrag), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte
                            Interessen)
                        </p>
                        <p className="mb-4">
                        ...
                        <p className="mb-4">
                            ...
                            Geschäftsvorgangs verarbeitet. Die Daten bleiben bei
                            uns solange gespeichert, wie es das Gesetz
                            vorschreibt.
                        </p>
                        <h3 className="heading-script-sm text-lg mb-2 text-gray-900">
                            Betroffene Personen
                        ...
                        <p className="mb-4">
                            ...
                            (Computer, Laptop, Smartphone,...) gespeichert und
                            es kommt zur Speicherung von Daten auf dem
                        ...
                        <ul className="list-disc list-inside mb-4 space-y-1">
                            <li>
                                ...
                                geben uns die Einwilligung Ihre Daten zu
                                speichern und weiter für den Geschäftsfall
                                betreffende Zwecke zu verwenden;
                            </li>
                            <li>
                                Art. 6 Abs. 1 lit. b DSGVO (Vertrag): Es besteht
                                die Notwendigkeit für die Erfüllung eines
                                Vertrags mit Ihnen oder einem
                                Auftragsverarbeiter wie z. B. dem
                            ...
                            <li>
                                ...
                                Mobilfunkbetreiber notwendig, um die
            ...
            <section>
                <h2 className="heading-script text-xl mb-3 text-gray-900">GitHub Pages Hosting</h2>
                <p className="mb-4">
                    Diese Website wird auf GitHub Pages gehostet, einem Dienst von GitHub, Inc. Beim Besuch dieser Website können bestimmte technische Daten (z. B. IP-Adressen, Browsertyp und Zugriffszeiten) von GitHub zu Sicherheits- und Betriebszwecken protokolliert werden.
                </p>
                <p className="mb-4">
                    Weitere Informationen darüber, wie GitHub Besucherdaten verarbeitet, finden Sie in den offiziellen Datenschutzrichtlinien von GitHub:
                </p>
                ...
                <p>
                    Diese Website sammelt, speichert oder verarbeitet keine personenbezogenen Daten über das hinaus, was für die Kommunikation erforderlich ist (z. B. wenn Benutzer uns per E-Mail kontaktieren).
                </p>
            </section>
