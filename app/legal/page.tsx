...
export default function LegalPage() {
    return (
        <main className="max-w-3xl mx-auto p-8 space-y-6 text-gray-700">
            <h1 className="font-glitch-sm text-3xl text-gray-900 mb-6 tracking-wide">IMPRESSUM</h1>
            ...
            <section>
                ...
                <p>
                    Mühlweg 4<br />
                    7062 St. Margarethen im Burgenland<br />
                    Österreich
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    E-Mail: <a href="mailto:roahraschlareloaded@gmail.com" className="underline">roahraschlareloaded@gmail.com</a><br />
                    Telefon: <a href="tel:+436764072973" className="underline">+43 676 4072973</a>
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    Diese Website dient der Information über den Musikverein Roah-Raschla Reloaded,
                    seine Aktivitäten und Veranstaltungen.
                </p>
            </section>

            <section>
                <h2 className="font-glitch-sm text-lg text-gray-900 mb-2 tracking-wide">HINWEIS</h2>
                <p>
                    Roah-Raschla Reloaded ist ein gemeinnütziger Verein gemäß den Bestimmungen des österreichischen Vereinsgesetzes.
                </p>
            </section>

            <section>
                <h2 className="font-glitch-sm text-lg text-gray-900 mb-2 tracking-wide">HAFTUNGSAUSSCHLUSS</h2>

                <h3 className="font-glitch-sm font-semibold mb-2 tracking-wide">HAFTUNG FÜR INHALTE</h3>
                <p className="mb-4">
                ...
                <h3 className="font-glitch-sm font-semibold mb-2 tracking-wide">HAFTUNG FÜR LINKS</h3>
                <p>
